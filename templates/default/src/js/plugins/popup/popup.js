; (function (global) {
	...
	Popup.prototype = {
		...
		show: function (callback) {
			...
			// Create the event
			var event = new CustomEvent("popup:shown");
		...
		close: function (clear, callback) {
			...
			// Тригерим событие чтобы можно было выполнить операции с дом до закрытия попапа
			// Create the event
			var event = new CustomEvent("popup:closed");
